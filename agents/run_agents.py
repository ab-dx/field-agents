...
async def run_agents():
    ...
    for src, agent in agents:
        ...
        if hasattr(structured_output, "reviews"):
            first_review = structured_output.reviews[0]
            
            #CUSTOMER REALM
            if hasattr(first_review, "csat_score") or hasattr(first_review, "nps_score"):
            ...
            #EMPLOYEE REALM
            elif hasattr(first_review, "esat_score") or hasattr(first_review, "enps_score"):
